...
namespace TAHL.Transmission
{
    ...
    {
        private GameObject _gameWinDialog;
        ...
        private void Awake()
        {
            ...
            _gameWinDialog = GameObject.FindGameObjectWithTag(Globals.Tags.GameWinDialog);
            _gameMenuDialog.SetActive(false);
            _gameWinDialog.SetActive(false);
        }
